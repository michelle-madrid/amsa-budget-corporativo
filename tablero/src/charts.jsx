...
function BarYears({ series, unit, decimals, showProp }) {
  ...
  // 2026 YTD (acumulado hasta el mes de corte YTD_HASTA_MES): barra aparte (teal) si hay datos.
...
function ComplianceBars({ series, thr, unit }) {
  ...
  // 2026 YTD: % de cumplimiento del acumulado hasta el mes de corte (Real / Ppto), barra atenuada.
  if (series[2026] && (series[2026].real || series[2026].plan))
