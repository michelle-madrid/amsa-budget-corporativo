...
Uso:  python utilidades/aplanar_maestro.py "uploads/Reales Distribuibles Histórico v2.xlsx"
"""
import os
import sys
import shutil
...
def main():
    if len(sys.argv) < 2:
        raise SystemExit("Uso: python utilidades/aplanar_maestro.py \"<maestro.xlsx>\"")
    path = sys.argv[1]
