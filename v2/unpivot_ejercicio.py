...
Uso
---
    python v2/unpivot_ejercicio.py "v2/uploads/ejercicios_2026/Outlook 6+6 2026.XLSX"
    python v2/unpivot_ejercicio.py "<archivo.xlsx>" --salida "Outlook 6+6 Unpivot"
    python v2/unpivot_ejercicio.py "<archivo.xlsx>" --anio-destino 2028 --hoja Sheet1
